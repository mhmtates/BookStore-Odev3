...
namespace WebApi.Controllers
{
    ...
    public class AuthorController : ControllerBase
    {
       ...
       [HttpPost]
       public IActionResult AddAuthor([FromBody] CreateAuthorViewModel authormodel)
        {
        ...
        [HttpPut("{id}")]
        public IActionResult UpdateAuthor(int id, [FromBody] UpdateAuthorViewModel changedAuthor)
        {
            UpdateAuthorCommand command = new UpdateAuthorCommand(_context);
            command.AuthorId = id;
            command.Model = changedAuthor;
